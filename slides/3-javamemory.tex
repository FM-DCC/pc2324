...
\begin{lstlisting}[emph={synchronized,sleep,log,thread,join}]
...
\begin{lstlisting}[emph={sleep,log,thread,join,synchronized,wait,notify,shutdown}]
object Worker extends Thread {
...
\begin{itemize}
  ...
  \item Objects with only non-final fields
    \begin{itemize}
      \item \alert{do not need synchronisation} when shared
    \end{itemize}
